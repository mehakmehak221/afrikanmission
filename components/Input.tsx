  ...
  return (
    <div className="flex flex-col gap-2 group">
      ...
      <input
        ...
        className={`
          w-full bg-transparent border-b border-hairline
          px-0 py-3 text-paper placeholder-mute/60
          font-body text-base md:text-lg
          transition-all duration-500 premium-ease
          hover:border-gold/50
          focus:border-gold focus:shadow-[0_1px_0_0_#D4AF37] focus:bg-gold/5
          ${error ? "border-ember focus:border-ember focus:shadow-[0_1px_0_0_#DA4003]" : ""}
          ${className}
        `}
        {...props}
      />
